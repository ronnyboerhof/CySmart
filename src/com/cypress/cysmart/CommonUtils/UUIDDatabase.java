...
public class UUIDDatabase {
    ...
    /**
     * Iridium Burst related UUID
     */
    public final static UUID UUID_IRIDIUM_BURST_SERVICE = UUID
            .fromString(GattAttributes.IRIDIUM_BURST_SERVICE);
    public final static UUID UUID_IRIDIUM_BURST_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_BURST_TEXT);

    public final static UUID UUID_IRIDIUM_STATUS_IMEI_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_STATUS_IMEI);
    public final static UUID UUID_IRIDIUM_STATUS_SIGNAL_LEVEL_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_STATUS_SIGNAL_LEVEL);
    public final static UUID UUID_IRIDIUM_STATUS_NEWORK_STATUS_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_STATUS_NETWORK_STATUS);


    public final static UUID UUID_IRIDIUM_MESSAGE_STATUS_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_MESSAGE_STATUS);
    public final static UUID UUID_IRIDIUM_MESSAGE_TEXT1_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_MESSAGE_TEXT1);
    public final static UUID UUID_IRIDIUM_MESSAGE_TEXT2_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_MESSAGE_TEXT2);
    public final static UUID UUID_IRIDIUM_MESSAGE_TEXT3_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_MESSAGE_TEXT3);
    public final static UUID UUID_IRIDIUM_MESSAGE_TEXT4_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_MESSAGE_TEXT4);
    public final static UUID UUID_IRIDIUM_MESSAGE_TEXT5_TEXT = UUID
            .fromString(GattAttributes.IRIDIUM_MESSAGE_TEXT5);
