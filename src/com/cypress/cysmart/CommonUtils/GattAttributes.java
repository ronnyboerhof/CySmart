...
public class GattAttributes {
    ...
    static {
        ...
        attributesImageMap.put(BATTERY_SERVICE,// "0000180f-0000-1000-8000-00805f9b34fb",
                R.drawable.battery);
        attributesImageMap.put(IRIDIUM_BURST_SERVICE,
                R.drawable.irdium_burst_service);
        attributesImageMap.put(IRIDIUM_STATUS_SERVICE,
                R.drawable.irdium_status_service);
        ...
        attributesImageMap.put(RGB_LED_SERVICE, R.drawable.rgb_led);
        attributesImageMap.put(CAPSENSE_SERVICE_CUSTOM, R.drawable.capsense);
        attributesImageMap.put(CAPSENSE_SLIDER_CUSTOM, R.drawable.capsense_slider);
        attributesImageMap.put(CAPSENSE_PROXIMITY_CUSTOM, R.drawable.capsense_slider);
        attributesImageMap.put(CAPSENSE_BUTTONS_CUSTOM, R.drawable.capsense_buttons);
        attributesImageMap.put(RGB_LED_SERVICE_CUSTOM, R.drawable.rgb_led);
        attributesImageMap.put(IMMEDIATE_ALERT_SERVICE, R.drawable.find_me);
        attributesImageMap.put(LINK_LOSS_SERVICE, R.drawable.proximity);
        attributesImageMap.put(TRANSMISSION_POWER_SERVICE, R.drawable.proximity);
        ...
        attributesCapSenseImageMap.put(CAPSENSE_SERVICE_CUSTOM, R.drawable.capsense);
        attributesCapSenseImageMap.put(CAPSENSE_PROXIMITY_CUSTOM,
                R.drawable.capsense_proimity);
        attributesCapSenseImageMap.put(CAPSENSE_SLIDER_CUSTOM,
                R.drawable.capsense_slider);
        attributesCapSenseImageMap.put(CAPSENSE_BUTTONS_CUSTOM,
                R.drawable.capsense_buttons);
        //RDK
        attributesImageMap.put(HUMAN_INTERFACE_DEVICE_SERVICE,
                R.drawable.unknown);
        //OTA_FU
        attributesImageMap.put(OTA_UPDATE_SERVICE,
                R.drawable.otafu);
    ...
    public static int lookupImage(String uuid) {
    ...
    public static int lookupImageCapSense(String uuid) {
